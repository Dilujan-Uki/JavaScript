...
function main() {
    ...
    console.log("\n");
    console.log("The Perimiter of Circle1 is " + Math.floor(radius1.getArea()));
    console.log("The Perimiter of Circle2 is " + Math.floor(radius2.getArea()));
    console.log("The Perimiter of Circle3 is " + Math.floor(radius3.getArea()));
}
main();
